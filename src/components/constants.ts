...
// LEGEND DETAILS
export const UNCLUSTERED_LEGEND = [ { layer: "Parkrun", colour: PARKRUN_LAYER_DEFAULT_COLOUR }, { layer: "Nearby Parkrun", colour: PARKRUN_LAYER_NEAREST_COLOUR }, { layer: "Chosen Address", colour: ADDRESS_LAYER_DEFAULT_COLOUR } ];
export const CLUSTERED_LEGEND = [ ...UNCLUSTERED_LEGEND, { layer: "0-100 Parkruns", colour: PARKRUNS_CLUSTERED_FIRST_STEP_COLOUR }, { layer: "101-750 Parkruns", colour: PARKRUNS_CLUSTERED_SECOND_STEP_COLOUR }, { layer: "751+ Parkruns", colour: PARKRUNS_CLUSTERED_THIRD_STEP_COLOUR } ];
